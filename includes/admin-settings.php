...
?>
	<div id="cap-border-simple" <?php echo $simple_hidden; // WPCS: XSS ok. 
								?>>
		<div style="display: flex; align-items: center; gap: 8px;">
			<input
				type="text"
	...
	<div id="cap-border-advanced" <?php echo $advanced_hidden; // WPCS: XSS ok. 
									?>>
		<div style="display: flex; align-items: center; gap: 8px;">
			<input
				type="text"
...
{
	$options = get_option('cap_captcha_options');
	$checked = ! empty($options[$args['field']]) ? 'checked' : '';
?>
	<label>
		<input
			type="checkbox"
